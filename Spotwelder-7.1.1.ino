...
A folder has been created with the required libraries for the spot welder. Install it as follows:
Go to the Arduino folder in C: \ Program Files.
Rename the libraries folder temporarily to libraries2.
Copy the spot welder libraries folder to the Arduino folder.
